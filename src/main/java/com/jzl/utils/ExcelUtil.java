 ...
 * @Author: jzl
 * @Description:
 * @Date: Created in 10:03 2019/3/18
 * @Modified By:
 */
public class ExcelUtil {
     ...
     * @see [类、类#方法、类#成员]
     */
    public List<List<String>> readDate(Workbook wb) {
        ...
        for (int r = 0; r < totalRows; r++) {
            ...
            for (int c = 0; c < getTotalCells(); c++) {
                ...
                cellValue = getString(cell, cellValue);
    ...
    private static String getString(Cell cell, String cellValue) {
        if (null != cell) {
            // 以下是判断数据的类型
            switch (cell.getCellType()) {
                case NUMERIC: // 数字
                    if (org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(cell)) {
                        ...
                        SimpleDateFormat dff = new SimpleDateFormat("yyyy-MM-dd HH:mm:sss");
